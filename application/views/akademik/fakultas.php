    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a href="<?=base_url('ak/fakultas/in_fakultas')?>"><button class="btn btn-success  float-right">Tambah Fakultas Baru</button></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
          <p>Anda yakin akan menghapus data fakultas ini ?</p>
        </center>
      </div>
