...
<head>
  ...
  <title>Siakad 0.1 | Akademik</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?=base_url('asset/img/AdminLTELogo.png')?>"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">SIAKAD 0.1</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?=$this->session->user?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url('ak/dosen')?>" class="nav-link">
              <i class="far fa-user nav-icon"></i>
              <p>Master Dosen</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url('ak/mahasiswa')?>" class="nav-link">
              <i class="far fa-user nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url('ak/fakultas')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Fakultas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('ak/jurusan')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Jurusan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('ak/tahunAjar')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="<?=base_url('ak/kelas')?>" class="nav-link">
